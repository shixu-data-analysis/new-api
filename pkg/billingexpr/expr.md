...
| Frontend expression helpers | `web/src/features/pricing/lib/tier-expr.ts`, `web/src/features/pricing/lib/billing-expr.ts` |
| Model detail | `web/src/features/pricing/components/dynamic-pricing-breakdown.tsx` |
| Log display | `web/src/features/usage-logs/lib/format.ts`, `web/src/features/usage-logs/lib/columns.ts`, `web/src/features/usage-logs/components/dialogs/details-dialog.tsx` |
