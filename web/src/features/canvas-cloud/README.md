...
- Keep reviewed model release import, diff planning, draft creation, approval, and publication as separate administrator calls. Approval/publication controls require a fresh plan whose SHA matches the stored release manifest.
