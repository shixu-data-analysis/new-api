...
export const STATIC_I18N_KEYS = [
  ...
  // Canvas Agent and provider pricing governance
  'Inviter center',
  'Inviter',
  'Confirm creation',
  'My invite codes',
  'My customers',
  'Customers activated through invite codes assigned to you.',
  'Codes stay masked until an audited display or copy action.',
  'Show invite code',
  'Copy invite code',
  'Invite code could not be revealed',
  'Used / Capacity',
  'Activated customers',
  'Activated at',
  'Billing unit',
  ...
  'Show recharge code',
  'Copy recharge code',
  'Recharge code copied',
  'Recharge code could not be revealed',
  'Enter a complete recharge code',
  'No inviters match current filters',
  'No invite codes match current filters',
  'Enter a quantity from 1 to 100',
  'Unassociated',
  'Copy inviter username',
  ...
  'Unable to load task records',
  'No task records',
  'Task details failed to load',
  'Task parameters',
  'Call records',
  'Execution details',
  'Point records',
  'Deducted points',
  'Unable to load point ledger details',
  'Back to task details',
  'Ledger ID',
  'Source lot',
  'Unable to load point records',
  'No point records',
  'View ledger',
  'Call ID',
  'Call type',
  ...
  'Risk action',
  'Safe price scheduled',
  'Pause quality',
  'Limited loss window',
  'Loss deadline',
  'Maximum expected loss points',
  'Record risk decision',
  'Current decision',
  'Pricing risk decision recorded',
  'Pricing risk decision could not be recorded',
  'Confirm pricing risk decision?',
  ...
  // Canvas table filter defaults
  'All models',
  'All execution statuses',
  'All settlement progresses',
  'All billing statuses',
  'All call states',
  'All changes',
  'All lot types',
  'All actions',
  'All customer display states',
  'All reasons',
  'All combinations',
  'All price plans',
  'All billing modes',
  'All binding statuses',
  'All roles',

  // Canvas global task records (dynamic ledger-event × lot-type labels)
