...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			userRoute.GET("/canvas/customer-center-handoff", middleware.CriticalRateLimit(), middleware.DisableCache(), controller.ConsumeCanvasCustomerCenterHandoff)
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/canvas/access-key", middleware.CriticalRateLimit(), middleware.UserCriticalRateLimit("canvas-access-key"), middleware.DisableCache(), controller.EnsureCanvasAccessKey)
				selfRoute.POST("/canvas/customer-center-handoff", middleware.CriticalRateLimit(), middleware.UserCriticalRateLimit("canvas-customer-center"), middleware.DisableCache(), controller.CreateCanvasCustomerCenterHandoff)
