...
const (
	...
	MsgUserRegistrationIdentityUnavailable   = "user.registration_identity_unavailable"
	...
	MsgUserRoleChangeRequiresSeparateAccount = "user.role_change_requires_separate_account"
